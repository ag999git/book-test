...
#### You can see an example script which renders Label, Button and Window using Composite Design Pattern [Here](https://github.com/ag999git/book-test/blob/main/design-patterns-python/adapter-design-pattern.md?plain=1)
